...
nav_order: 20220331
difficulty: Easy
challenge_title: "Pinned"
platform: HackTheBox
reading_time: 5 min
screenshots: /assets/images/Screenshots/Pinned/
tags: HackTheBox Challenge Android reversing bypass-certificate-pinning frida Xposed TrustMeAlready SSLUnpinning

image: /assets/images/Screenshots/Pinned/Thumbnail.png
twitter_text: Learn how to bypass certificate pinning with Frida and Xposed in this Android HackTheBox challange called Pinned. 
...
{% include header.html %}
![Thumbnail.png]({{page.screenshots}}Thumbnail1.png)
