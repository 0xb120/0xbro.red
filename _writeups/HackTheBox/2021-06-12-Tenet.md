...
difficulty: Medium
reading_time: 11 min
screenshots: /assets/images/Screenshots/Tenet/
tags: HackTheBox Medium Linux B2R code-review php-deserialization password-reuse hardcoded-credentials race-condition temp-file-poisoning writeup

twitter_text: HackTheBox &quot;Tenet&quot; wirteup is now available!
description: Tenet is an medium difficulty Linux machine on HackTheBox vulnerable to PHP deserialization vulnerability and based on code review.
---
...
![Pasted image 20210507210944.png]({{page.screenshots}}Pasted image 20210507210944.png)

Because SSH usually does not offer a large attack surface, enumeration of target was primary focused on port 80.
In order to find any possible entry point, web files and directories were enumerated using gobuster:
```bash
┌──(kali㉿kali)-[~/CTFs/HTB/box/Tenet]
...
![Pasted image 20210507211948.png]({{page.screenshots}}Pasted image 20210507211948.png)
...
```
![Pasted image 20210507212245.png]({{page.screenshots}}Pasted image 20210507212245.png)
...
![Pasted image 20210519231607.png]({{page.screenshots}}Pasted image 20210519231607.png)
![Pasted image 20210519231100.png]({{page.screenshots}}Pasted image 20210519231100.png)
![Pasted image 20210519231139.png]({{page.screenshots}}Pasted image 20210519231139.png)
...
![Pasted image 20210508001613.png]({{page.screenshots}}Pasted image 20210508001613.png)

`test.txt` was created, meaning that the **PoC worked** and the target is vulnerable:
![Pasted image 20210508001702.png]({{page.screenshots}}Pasted image 20210508001702.png)
...
![Pasted image 20210508002157.png]({{page.screenshots}}Pasted image 20210508002157.png)
![Pasted image 20210508002210.png]({{page.screenshots}}Pasted image 20210508002210.png)

Finally the reverse shell command was sent to the web shell and a reverse connection was obtained:
...
![Pasted image 20210508141146.png]({{page.screenshots}}Pasted image 20210508141146.png)


## Trophy
```
In a parallel worlds theory, we can't know the relationship between consciousness
and multiple realities. Does your head hurt yet ? Try to get some sleep.
- Neil
```

## Video
<iframe width="560" height="315" src="https://www.youtube.com/embed/_TzptHZLVgs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
