...
difficulty: Easy
reading_time: 15 min
screenshots: /assets/images/Screenshots/Timelapse/
tags: .pfx-files, LAPS, Windows, anonymous-smb, cracking-pfx-files, cracking-zip-files, credentials-in-LAPS, credentials-in-history, weak-credentials

image: /assets/images/Screenshots/Timelapse/Timelapse.png
twitter_text: HackTheBox &quot;Timelapse&quot; wirteup is now available!

---

{% include header.html %}
![box-summary.jpg]({{page.screenshots}}Timelapse.png)
...
Extracted credentials from LAPS ([Pentesting LAPS](https://viperone.gitbook.io/pentest-everything/everything/everything-active-directory/laps)):
