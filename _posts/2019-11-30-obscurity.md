...
tags: [hackthebox]
description: HackTheBox &quot;Obscurity&quot; wirteup is now available!
toc: true
media_subpath: /assets/img/Obscurity/
image: iconTable.png
---
...
On the other hand, by opening the intercepted file, we will be able to **extract the hash of the root user** to crack it with **john**.
